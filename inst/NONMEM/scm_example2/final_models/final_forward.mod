...
$TABLE      ID TIME DV IPRED PRED RES WRES CPRED CWRES EPRED ERES
            ...
            FILE=C:\Projects\Software\ToolDevelopment\qpToolkit\inst\NONMEM\scm_example2\forward_scm_dir1\scm_dir1\scm_dir1//m1/V1GNDR2.mod.example2.sdtab
            NOPRINT
$TABLE      ID CL V1 Q V2 ETA1 ETA2 ETA3 ETA4 NOAPPEND ONEHEADER
            NOPRINT
            FILE=C:\Projects\Software\ToolDevelopment\qpToolkit\inst\NONMEM\scm_example2\forward_scm_dir1\scm_dir1\scm_dir1//m1/V1GNDR2.mod.example2.patab
$TABLE      ID AGE GNDR NOAPPEND ONEHEADER NOPRINT
            FILE=C:\Projects\Software\ToolDevelopment\qpToolkit\inst\NONMEM\scm_example2\forward_scm_dir1\scm_dir1\scm_dir1//m1/V1GNDR2.mod.example2.catab
